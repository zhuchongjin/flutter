...
class StudyDemos extends StatelessWidget {
  const StudyDemos({Key? key}) : super(key: key);
...
class StudyDemosList extends StatelessWidget {
  const StudyDemosList({Key? key}) : super(key: key);
      ...
      children: [
          ...
          child: GestureDetector(
            ...
            onTap: () {
              Navigator.push(context,
                  new MaterialPageRoute(builder: (context) => new RowDemo()));
            },
          ),
        ),
        Container(
        ...
        Container(
          ...
          child: GestureDetector(
            ...
            onTap: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => CartDemo()));
            },
          ),
        ),
        // 分割线
        ...
        Container(
          ...
          child: GestureDetector(
            ...
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => NavProductDemo()));
            },
          ),
        ),
        Divider(),
